...
const data: GSBData[] = [
  { metric: 'Semantics Following', good: 42, same: 10, bad: 6 },
  { metric: 'Editing Consistency', good: 18, same: 36, bad: 4 },
  { metric: 'Perceptual Fidelity', good: 26, same: 26, bad: 6 },
];
...
export default function GSBChart_Runway() {
  return (
    <div className="w-full my-8 text-white">
      {/* Title */}
      <div className="text-center mb-6">
        <h4 className="text-2xl font-semibold">X-MoTion VS Runway-Aleph</h4>
      </div>
      ...
      <div className="mb-6 text-left max-w-5xl mx-auto">
        <div className="mb-1">
          ...
          <span className="text-lg font-bold">36.90%</span>
        </div>
